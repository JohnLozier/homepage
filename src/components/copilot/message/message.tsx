...
const Message = ({ from, message }: MessageType, index: Accessor<number>) => {
	...
	return <div class="flex flex-col gap-y-2">
		<Title from={ from } />
		{ from == "user" ?
			<div class="font-mona font-medium [&>*]:animate-fadeIn [&>*]:opacity-0 break-words text-white/70">
